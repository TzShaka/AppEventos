                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if ((_userData!['modoContrato'] != null &&
                                        _userData!['modoContrato']
                                            .toString()
                                            .isNotEmpty) ||
                                    (_userData!['modalidadEstudio'] != null &&
                                        _userData!['modalidadEstudio']
                                            .toString()
                                            .isNotEmpty) ||
                                    (_userData!['sede'] != null &&
                                        _userData!['sede']
                                  ...
                                  if (_userData!['modalidadEstudio'] != null &&
                                      _userData!['modalidadEstudio']
                                          .toString()
                                          .isNotEmpty)
                                    _buildInfoCard(
                                      title: 'Modalidad Estudio',
                                      value: _userData!['modalidadEstudio'],
                                      icon: Icons.menu_book,
                                      iconColor: const Color(0xFFFFC107),
                                      delay: 1,
                                    ),
                                  if (_userData!['sede'] != null &&
                                      _userData!['sede'].toString().isNotEmpty)
                                    _buildInfoCard(
                                      title: 'Sede',
                                      value: _userData!['sede'],
                                ...
                                // Botón animado para ver asistencias
